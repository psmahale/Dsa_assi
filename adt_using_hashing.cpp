...
cin>>n;
 ...
 {
 if(h[hi].key%10!=hi) //check location is not empty and wheather the 
 ...
 for(i=0;i<hi && flag==0;i++) //To restart the search from first 
 ...
 for(i=0;i<hi && flag==0;i++) //to restart the search from 
